...
import com.example.retailapp.Model.Cart;
import com.example.retailapp.Prevalent.Prevalent;
import com.example.retailapp.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    public String user = Prevalent.currentOnlineUser.getPhone();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                intent.putExtra("Total Price = Rs.", String.valueOf(overTotalPrice));
